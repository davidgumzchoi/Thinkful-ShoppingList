...
// OVERVIEW
// In this project, starting from scratch you’ll build a JavaScript version of "Hot or Cold" (commonly known as "Huckle buckle beanstalk", obviously!).
// You remember the game, don't you? The hider knows where one object is, and a seeker has to find it.
// Each time the seeker makes a guess, the hider responds "getting hotter" if she's getting closer, or "getting colder" if she's moved farther away.
// For your version of the game, the computer will be hiding a number, and your user will be trying to find it.

// To build this game, you should use functions, conditionals, random numbers, and a "scoped" variable as described here (http://eloquentjavascript.net/chapter3.html#p9d662d5).
// This should help you understand the mindset of a programmer.
...
// The user should get feedback about their guess -if it was too high, too low, or just right.
// Initially, don't worry about telling users if they're getting "hotter" or "colder", just tell them if there previous guess was "hot" or "cold".
...
// Your app should ensure that users provide valid inputs.
// For instance, if a user submits a spaces, a blank guess, or letters, they should receive feedback that they need to input a number.
